...
class Auroris(ctk.CTk):
    def __init__(self):
        ...
        self.bg_image = ctk.CTkImage(Image.open("AURORIS/imgs/background.png"), size=(900, 600))
    ...
    def create_static_buttons(self):
        ...
        def show_how_popup():
            ...
            label = ctk.CTkLabel(popup, text="(explanation)", font=("Verdana", 13))
            label.pack(pady=50)
        ...
        github_image = ctk.CTkImage(Image.open("AURORIS/imgs/git.png"), size=(25, 25))
